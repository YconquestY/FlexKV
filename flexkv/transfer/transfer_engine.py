...
class TransferEngine:
    ...
    def _init_workers(self) -> None:
        ...
        # Initialize indexer workers (mirrors main KV workers, placed after main KV init)
    ...
    def _scheduler_loop(self) -> None:
        ...
        while self._running:
            try:
                ...
                # End NVTX ranges for finalized ops
    ...
    def _assign_op_to_worker(self, op: TransferOp) -> None:
        ...
        if self._has_indexer and op.transfer_type in self._indexer_worker_map:
            # Increment pending_count BEFORE submitting to indexer worker to avoid
            # a race where the worker completes before the counter is incremented.
            op.pending_count += 1
